...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/PXAndrew/RepoTest"
  ...
  s.source       = { :git => "https://github.com/PXAndrew/RepoTest.git", :tag => s.version.to_s }
  ...
  s.source_files  = "RepoTest/RepoTest/**/*.{h,m}"
